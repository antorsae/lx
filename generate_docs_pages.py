...
<body>
    ...
    <main>
        ...
        <div class="card" style="margin-bottom: 2rem; border-left: 4px solid #0f766e;">
            <div class="card-body">
                <h3>Synthetic CDSL Design</h3>
                <p style="margin-bottom: 1rem; color: var(--text-muted);">
                    Multi-candidate synthetic CDSL optimization from Juan baffleless driver measurements,
                    with IIR filters, polar plots, and LX521 comparison.
                </p>
                <ul class="link-list">
