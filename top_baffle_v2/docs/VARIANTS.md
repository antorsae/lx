...
`build/bmr_crescent_TEBM35C10-4/`. It is a minimal D66 pod on two drafted
struts — it keeps the released ND25FW-4 crescent's UM-collar mate exactly, so
the two are swappable without touching the UM print, and keeps nothing else of
that crescent's outline. It is 66.00 × 89.67 × 50.20 mm and 105.79 cm³.
Full description, including the six open qualification items, is in
...
|---|---|---|
| Driver axes | two, 49.3 mm apart in Y at y=443.931 and y=493.231 | one, at y=468.193 — the released face-to-face acoustic axis |
...
| Shared wall | none — the two pockets sit side by side | a 2.40 mm partition, two independent 1.20 mm blind walls back to back |
| Mounts on | the seam-B vase interface, replacing piece `04` | the UM half-lap ears at x=±24, y=421.5, on two drafted struts |
| Surrounding structure | the full vase piece it replaces | none — a straight D66 pod, the driver land itself, 6.25 mm inside the released scallop |
