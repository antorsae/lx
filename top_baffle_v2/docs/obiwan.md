...
| `src/lx521_baffle/obiwan/attachments.py` | Optional tweeter crescent with complete standalone blind-M3 receiver ears plus two mirrored vertical M2 x 8 center ties at x=+/-16.5 (blind Ø3.2 heat-set receivers in the crescent web underside, burial proven by a coaxial probe; Ø4.4 counterbore seats and Ø2.4 clearance bores live in the UM carrier's rear-open void); any cable retention is external/non-modeled, and magnets receive zero structural load credit |
