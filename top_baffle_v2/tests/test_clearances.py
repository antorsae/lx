...
def test_v0_duct_corridor():
    ...
    positive backing."""
    import lx521_baffle.proud.top_baffle_nd25fw4_v0 as v0
    from lx521_baffle.base import (
        UM_CUTOUT,
        UM_PILOT_ANGLES_DEG,
        UM_PILOT_D_MM,
...
def test_v0_captive_geometry():
    ...
    from lx521_baffle.proud.top_baffle_nd25fw4_b2_split import pieces
    import lx521_baffle.proud.top_baffle_nd25fw4_v0 as v0
    import lx521_baffle.proud.top_baffle_nd25fw4_v0_split as v0_split
...
def test_c7_duct_corridor():
    ...
    import lx521_baffle.proud.top_baffle_nd25fw4_c7 as c7
    from lx521_baffle.base import THICKNESS_MM
    from lx521_baffle.cables import CABLE_D, DUCT_Z
