...
def _obiwan_state_links(state: str, destination: str) -> list[Link]:
    ...
    links = [
        ...
        Link(
            ...
            f"{state_root}/obiwan_release_manifest.json",
            "candidate_manifest",
        ),
        Link(
            f"states/{destination}/images/routing.png",
            f"{state_root}/baffle_cable_routing_obiwan.png",
            "generated_routing",
        ),
    ]
        ...
        links.extend(
            [
                Link(
                    ...
                    "build/floor_stand/obiwan_integrated_floor_strength.json",
                    "analytical_screen",
                ),
                Link(
...
def _obiwan_links() -> list[Link]:
    links = [
        Link("images/wing_design_map.png", "build/common/obiwan_wing_design_map.png", "generated_wing_design_map"),
        Link("qualification.md", "docs/obiwan_physical_qualification.md", "physical_qualification_template"),
    ]
