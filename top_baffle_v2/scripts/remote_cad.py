...
# bmr_crescent_TEBM35C10-4 is the local-only candidate part's build root:
# its facts/manifest JSONs are regenerated by every local
# `make obiwan_bmr_crescent_cad` and are outputs, not inputs, of any
# remote goal — including them busted the snapshot identity the same way
