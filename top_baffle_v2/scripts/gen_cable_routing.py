...
def draw_terminal_service(ax, compact=False):
    ...
    from lx521_baffle.base import UM_TERMINAL_GAP_DEG
...
def _draw_obiwan_terminal_service(
    ...
    from lx521_baffle.obiwan.route import UM_MOUTH_TANGENT
...
def render_obiwan_engineering_detail():
    ...
    ax_front.annotate(
        ...
        "x=+/-32, y=18, z=15.10; matching flat/graded LM-lower receivers",
...
def render_obiwan():
    ...
    from lx521_baffle.flush import LM_RECESS_R, UM_RECESS_R
    from lx521_baffle.obiwan.carriers import (
        LM_CORE_R, side_ring_outer_plan)
    from lx521_baffle.obiwan.bridge import bridge_face_plan
    from lx521_baffle.obiwan.floor import (
    ...
    out = f"baffle_cable_routing_{ROUTING_PROFILE}.png"
    _prune_legacy_routing_png()
    # Preserve the explicit 1860x1200 review canvas. Tight bounding boxes
    # make the output size font-metric-dependent and can crop this 12.4x8.0
    # inch release sheet below the fail-closed 1600x1200 review minimum.
