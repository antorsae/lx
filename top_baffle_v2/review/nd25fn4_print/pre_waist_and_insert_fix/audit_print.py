...
def settings_check(project,prepared):
    ...
    keys=['printer_model','nozzle_diameter','nozzle_volume_type','filament_settings_id','filament_map',
          ...
          'support_object_xy_distance','flush_volumes_matrix','flush_into_infill','flush_into_objects','flush_into_support']
...
def support_ducts(gcode,prep):
    ...
    minimum=float('inf');count=0;failures=[]
...
def main():
    ...
    report=dict(project_sha256=sha(project),settings=process,
