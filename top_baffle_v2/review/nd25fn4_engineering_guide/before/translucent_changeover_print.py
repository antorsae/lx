...
Sliced native Bambu Studio files for the **P2S, 0.6 mm High Flow nozzle**.
...
PETG printing: **250 °C first layer / 245 °C later**, flow 0.95, printing limit 16 mm³/s. PLA printing: **220 °C**, flow 0.98, printing limit 12 mm³/s. Both materials keep the bed at **70 °C**. The native changeover temperature requests are preserved from the existing translucent recipe.
