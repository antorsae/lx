...
from ..base import baffle_solid
from .a_comp import OUTLINE_A_COMP
from .attachments import MIN_SOLID_MM3, _box, _two_sides
from .b import (
    A_COMP_CREST_Y,
    TWEETER_DROP_MM,
    apply_magnet_attachment_cavities,
)
from .b1 import OUTLINE_B1
from .b2 import OUTLINE_B2
from .v1 import REAR_MM, V1_MAGNET_ZC, Y_STEP
...
def gen_step():
    return ordered_labeled_compound(
        v1_attachments(),
        label="lx521_4_top_baffle_v1_attachments",
    )
