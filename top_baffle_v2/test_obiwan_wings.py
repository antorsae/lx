...
NO_FLOOR_STAGE_MANIFEST = (
    ROOT / "no_floor_stand/.obiwan_stage/manifest.json")
FLOOR_STAGE_MANIFEST = ROOT / "floor_stand/.obiwan_stage/manifest.json"
VARIANT_IDS = ("ac", "ae")
...
def _artifact_root() -> Path:
    raw = os.environ.get("LX_OBIWAN_WING_ARTIFACT_ROOT", "wings")
    path = Path(raw)
...
def _source_hash_records(source: dict) -> tuple[tuple[str, str], ...]:
    ...
    assert module == "obiwan_wings_cad", (
