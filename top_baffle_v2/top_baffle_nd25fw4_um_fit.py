...
W22_REFERENCE_STEP = Path(__file__).resolve().parent.parent / "E0022_W22EX001.stp"
...
def rear_cable_envelope(routing_profile: str):
    ...
    if routing_profile == "proud":
        from top_baffle_nd25fw4_cables import UM_HANDOFF
...
def _proud_curved_grommet():
    ...
    """
    from top_baffle_nd25fw4_cables import UM_HANDOFF, UM_HANDOFF_R_MM
