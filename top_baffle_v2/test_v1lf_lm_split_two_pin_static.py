"""Pure/static contract for the optional V1LF LM two-pin split.
...
containment and route-shell checks remain in ``test_v1lf_r6f.py`` and run on
the remote CAD host.
"""
...
SOURCE_PATH = HERE / "top_baffle_nd25fw4_v1lf_lm_split.py"
