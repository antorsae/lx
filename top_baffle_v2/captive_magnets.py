...
# Purchased component and proven captive-cavity dimensions.
...
# The coupon's CAD roof plane is snapped to a 0.20-mm construction grid.
# Actual pause markers remain a slicer/G-code fact; this is not a claim that
# every print uses 0.20-mm layers.
...
# Quantize nominal millimetre facts before they cross the CAD/JSON boundary.
# Binary floating point otherwise serializes the approved 0.45 + 2.10 + 0.45
# stack as 3.0000000000000004, which is not the frozen 3.00-mm release fact.
...
class CaptiveMagnetGeometryError(ValueError):
    """Raised when a requested site cannot realize the qualified topology."""
