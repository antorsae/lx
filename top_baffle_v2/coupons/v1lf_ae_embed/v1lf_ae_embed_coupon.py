"""Minimal two-piece V1LF LM/UM-to-Ae embedded-magnet coupon.

The source coordinate frame follows the released baffle convention: XY is
the installed front plane, local Z=0 is the V1LF rear datum, and local Z=11.5
...
# Reuse the released V1LF/Ae dimensional authorities instead of copying their
...
from gen_v1lf_basic_variants import (  # noqa: E402
    PAD_LM_RADIAL_MM,
...
from top_baffle_nd25fw4_v1lf import (  # noqa: E402
    CORE_REAR_Z,
    LM_CORE_R,
    LM_RECESS_R,
    SIDE_MAGNET_D,
...
def carrier_coupon_installed():
    ...
    return _single_solid(part, "v1lf_lm_um_carrier_embed_coupon")
...
def wing_coupon_installed():
    ...
    return _single_solid(part, "v1lf_ae_lm_um_embed_coupon")
...
def carrier_coupon_print():
    return _front_down(
        ...
        "v1lf_lm_um_carrier_embed_coupon_front_down",
    )
...
def wing_coupon_print():
    return _front_down(
        ...
        "v1lf_ae_lm_um_embed_coupon_front_down",
    )
...
def gen_step():
    ...
    assembly.label = "v1lf_ae_lm_um_embedded_magnet_coupon_pair"
    return assembly
