...
def outer_source_sha():
    ...
    value += json.dumps(model.policy()['hardware'], sort_keys=True)
...
def main():
    ...
    result = {"design_input_zip_sha256": ZIP_SHA256,
              ...
              "hardware_policy": model.policy()['hardware'],
    ...
    ring = g.extract(g.retainer_local,
                     [[-.8,5.2],[-g.M.retainer_outer_radius-1,g.M.retainer_outer_radius+1],
                      [-g.M.retainer_outer_radius-1,g.M.retainer_outer_radius+1]], min(args.step,.20),
